      ...
      children: [
        if (userImage != null)
          Positioned(
            ...
            right: isMe ? 0 : null,
            child: isMe ? Container(height: 10,width: 10,color: Colors.transparent,) : CircleAvatar(
        ...
        Container(
          ...
          // user's image.
          margin: isMe ? const EdgeInsets.all(0): const EdgeInsets.symmetric(horizontal: 46),
          child: Row(
            ...
            children: [
              Column(
                ...
                children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        ...
                        style:  TextStyle(
                          ...
                          color: isMe ? Colors.transparent : Colors.white54,
                  ...
                  // The "speech" box surrounding the message. rgb(77,56,162) //255, 18, 3, 17
                  Container(
                    decoration: BoxDecoration(
                      color: isMe
                          ? const Color.fromARGB(255, 23, 19, 40)//const Color.fromARGB(255, 77, 56, 162).withOpacity(0.7)//Colors.grey[300]
                          : const Color.fromARGB(255, 23, 19, 40).withOpacity(0.9),//theme.colorScheme.secondary.withAlpha(200),
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                        ...
                        // when multi lined.
                          ...
                          color: isMe
                              ? Colors.orange
                              : Colors.orange//theme.colorScheme.onSecondary,
                      ),
                      softWrap: true,
                    ),
                  ),
